...
✅ Merchant spend categories at `GET /merchants.html` (`merchant_categories`; new SMS merchants appear after classify; Dhan `category_name` on new withdrawals and on apply for already-pushed journals)
