...
✅ Telegram attention: new dues + new/repeated Firefly blocked (seed then delta); daily 08:00 IST digest of unpaid dues + Dhan reachability/blocked/last push; no spend summaries
