...
✅ Attention-only dashboard at `GET /` (dues, blocked pushes, services, last import; no Money charts). Services and Dues panels collapse from the heading; the choice is kept in the browser.
