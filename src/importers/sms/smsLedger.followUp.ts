...
export async function runSmsLedgerFollowUp(): Promise<void> {
    ...
    console.info(
        `Firefly push: posted=${stats.posted} already=${stats.alreadyPushed} rewritten=${stats.rewritten} rewriteFailed=${stats.rewriteFailed} skipped=${stats.skippedOpening} blocked=${stats.blocked} failed=${stats.failed}`
    );
